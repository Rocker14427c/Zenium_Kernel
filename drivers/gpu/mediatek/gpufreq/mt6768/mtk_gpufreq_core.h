...
#define SEG_GPU_DVFS_FREQ7			(1020000)	/* KHz */
#define SEG_GPU_DVFS_FREQ8			(990000)	/* KHz */
#define SEG_GPU_DVFS_FREQ9			(960000)	/* KHz */
#define SEG_GPU_DVFS_FREQ10			(930000)	/* KHz */
#define SEG_GPU_DVFS_FREQ11			(900000)	/* KHz */
#define SEG_GPU_DVFS_FREQ12			(870000)	/* KHz */
#define SEG_GPU_DVFS_FREQ13			(840000)	/* KHz */
#define SEG_GPU_DVFS_FREQ14			(810000)	/* KHz */
#define SEG_GPU_DVFS_FREQ15			(780000)	/* KHz */
#define SEG_GPU_DVFS_FREQ16			(750000)	/* KHz */
#define SEG_GPU_DVFS_FREQ17			(720000)	/* KHz */
#define SEG_GPU_DVFS_FREQ18			(690000)	/* KHz */
#define SEG_GPU_DVFS_FREQ19			(660000)	/* KHz */
#define SEG_GPU_DVFS_FREQ20			(630000)	/* KHz */
#define SEG_GPU_DVFS_FREQ21			(600000)	/* KHz */
#define SEG_GPU_DVFS_FREQ22			(570000)	/* KHz */
#define SEG_GPU_DVFS_FREQ23			(540000)	/* KHz */
#define SEG_GPU_DVFS_FREQ24			(510000)	/* KHz */
#define SEG_GPU_DVFS_FREQ25			(480000)	/* KHz */
#define SEG_GPU_DVFS_FREQ26			(450000)	/* KHz */
#define SEG_GPU_DVFS_FREQ27			(420000)	/* KHz */
#define SEG_GPU_DVFS_FREQ28			(390000)	/* KHz */
#define SEG_GPU_DVFS_FREQ29			(360000)	/* KHz */
#define SEG_GPU_DVFS_FREQ30			(330000)	/* KHz */
#define SEG_GPU_DVFS_FREQ31			(300000)	/* KHz */

#define SEG_GPU_DVFS_VOLT0		(100000)	/* mV x 100 */
#define SEG_GPU_DVFS_VOLT1		(98750)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT2		(97500)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT3		(96250)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT4		(95000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT5		(93750)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT6		(92500)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT7		(91250)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT8		(90000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT9		(88750)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT10		(87500)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT11		(86250)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT12		(85000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT13		(83750)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT14		(82500)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT15		(81250)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT16		(80000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT17		(78750)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT18		(77500)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT19		(76250)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT20		(75000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT21		(73750)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT22		(72500)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT23		(71250)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT24		(70000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT25		(68750)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT26		(67500)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT27		(66250)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT28		(65000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT29		(63750)		/* mV x 100 */
...
#define SEG_GPU_DVFS_VSRAM1		(108750)	/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM2		(107500)	/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM3		(106250)	/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM4		(105000)	/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM5		(103750)	/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM6		(102500)	/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM7		(101250)	/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM8		(100000)	/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM9		(98750)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM10		(97500)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM11		(96250)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM12		(95000)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM13		(93750)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM14		(92500)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM15		(91250)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM16		(90000)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM17		(88750)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM18		(87500)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM19		(86250)		/* mV x 100 */
