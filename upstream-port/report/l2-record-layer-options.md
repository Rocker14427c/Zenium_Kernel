...
`drivers/misc/mediatek/cmdq/v3/cmdq_record.c` (4,141 lines), which pulls in **no** other v3 engine file.
...
| size | 1 vendor .c (4,141 ln) + 2 headers + ~350-500 ln of header/helper delta + ~22 marked adaptations | +17,706 ln of engine .c (26,437 ln if `cmdq_test.c`/`cmdq_sec*.c` come too) + the mailbox conversion 0082 removed | ~1 file + 1 Makefile line |
