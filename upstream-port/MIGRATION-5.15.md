...
| series round-trip: `git am` of all 76 patches onto pristine `v5.15.220` reproduces the ported tree | **same git tree hash `9dd453b12333277806d36d19e966476ecf262a03 (tree; the *commit* is 311a10c28)`** |
...
| series round-trip | `git am` of the 76 patches onto pristine `v5.15.220` yields tree **`9dd453b12333277806d36d19e966476ecf262a03`** - identical to the tree that was compiled and linked. Assert the applied count as well as the hash: an empty glob leaves `git am` succeeding with nothing applied |
